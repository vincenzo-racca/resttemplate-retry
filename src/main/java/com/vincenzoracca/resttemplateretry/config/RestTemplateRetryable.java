...
import com.vincenzoracca.resttemplateretry.util.CustomRetryTemplateBuilder;
...
public class RestTemplateRetryable extends RestTemplate {
    ...
    public <T> T getForObject(@NonNull URI url, @NonNull Class<T> responseType) throws RestClientException {
        return retryTemplate.execute(retryContext -> super.getForObject(url, responseType));
    }
    ...
    public <T> T getForObject(@NonNull String url, @NonNull Class<T> responseType, @NonNull Object... uriVariables) throws RestClientException {
        return retryTemplate.execute(retryContext -> super.getForObject(url, responseType, uriVariables));
    }
    ...
    public <T> ResponseEntity<T> getForEntity(@NonNull URI url, @NonNull Class<T> responseType) throws RestClientException {
        return retryTemplate.execute(retryContext -> super.getForEntity(url, responseType));
    }
    ...
    public <T> ResponseEntity<T> getForEntity(@NonNull String url, @NonNull Class<T> responseType, @NonNull Object... uriVariables) throws RestClientException {
        return retryTemplate.execute(retryContext -> super.getForEntity(url, responseType, uriVariables));
    }

    @Override
    public <T> ResponseEntity<T> getForEntity(@NonNull String url, @NonNull Class<T> responseType, @NonNull Map<String, ?> uriVariables) throws RestClientException {
        return retryTemplate.execute(retryContext -> super.getForEntity(url, responseType, uriVariables));
    }
